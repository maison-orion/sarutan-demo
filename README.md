...
| 単語ページ | 中央＝単語・例文・意味・発音・動画／四隅＝品詞の違い・類義語・コアイメージ・解説／サル＝おさるさんの覚え方 | 四隅をタップ、または1本指で斜めに引っぱると（Google Maps 式・反対側の角が開く・引いている間は開く角が光る）ポップアップ。左下のコアイメージだけ別ページ（Word Sphere：中央にコアイメージ、周りに意味ごとの例文4つ）。サルは方言設定に合わせた覚え方。ほぼ真横に払うと前後の単語 |
